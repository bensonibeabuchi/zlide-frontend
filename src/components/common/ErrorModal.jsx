  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center backdrop-blur-sm z-50">
      <div className='bg-white rounded-md p-8 text-center w-96 relative'>
        ...
        <button
          onClick={closeModal}
          className='absolute -top-5 -right-4 text-white p-4 rounded-full bg-red-500 hover:bg-red-400 cursor-pointer hover:scale-105 hover:shadow-lg transition-all'
        >
          <FaTimes />
        </button>
      </div>
