...
const LoginModal = () => {
  ...
  return (
    <div className="absolute top-0 h-screen w-screen left-0 bg-black bg-opacity-50 flex items-center justify-center mx-auto backdrop-blur-sm">
        ...
        <div className='bg-[#F8F8F6] w-[500px] rounded-lg p-12 pb-24'>
          <h1 className='font-semibold text-4xl bg-gradient-to-r from-[#1F1053] via-[#0A1F79] to-[#5D05C8] inline-block text-transparent bg-clip-text p-4'>Login</h1> 
          ...
          <form className='p-4 mt-4' method='POST' onSubmit={onSubmit} >
            ...
            <div className='flex relative flex-col py-2'>
              ...
              <button type='button' onClick={toggleEyeOn}> {isEyeOn ? <IoMdEye className='relative left-[340px] top-8 hover:cursor-pointer' size={18} onClick={toggleShowPassword} /> : <IoMdEyeOff className='relative left-[340px] top-8 hover:cursor-pointer' size={18} onClick={toggleShowPassword} />} </button>
