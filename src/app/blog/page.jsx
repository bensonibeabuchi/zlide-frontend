...
<>
  ...
  <div
    className='bg-gradient-to-br from-[#FFD045] from-10% via-[#F1E0AD] via-30% to-[#E7C548] to-90% text-center items-center md:pt-64 pt-40 pb-32 px-8 md:gap-8 flex flex-col mx-auto md:h-[1024px]'>
    ...
    <form
      className='flex flex-col items-center space-y-2 mt-8 bg-gray-100 p-4 rounded-lg md:w-[600px] w-[400px] shadow-2xl'>
      <input name="subscribe" id="subscribe" placeholder='Email address' className='w-full rounded-md p-4 border' />
      <button type="submit" className='bg-[#FFD045] p-4 rounded-md w-full text-[#1f1073] font-semibold'>Subscribe to our
        mailing list</button>
    </form>
  </div>
  ...
  <div className='my-24 justify-center items-center flex'>
    <div className='max-w-[1920px] p-8 px-24 w-full'>
      <h2
        className='bg-gradient-to-br my-8 from-[#1f1073] from-10% via-[#0A1F79] via-30% to-[#5D05C8] to-90% inline-block text-transparent bg-clip-text font-semibold text-3xl'>
        Recent Blog Post</h2>
        ...
        <>
          <div>
            <div className='lg:h-[495px] lg:w-[607px]'>
              <Image src={blog.image} width={1000} height={1000} alt={blog.title}
            ...
            <div className='p-2'>
              ...
              <Link href={`/blog/${blog.slug}`}> <button
                className='bg-[#FFD045] font-medium p-4 rounded-md text-[#1f1073] my-4 hover:scale-105 hover:shadow-lg hover:text-white'>
              Read more</button>
              </Link>
            </div>
          </div>
  ...
  <div className='my-24 justify-center items-center flex'>
    <div className='max-w-[1920px] md:p-8 p-4 md:px-24 w-full'>
      <h2
        className='bg-gradient-to-br from-[#1f1073] from-10% via-[#0A1F79] via-30% to-[#5D05C8] to-90% inline-block text-transparent bg-clip-text font-semibold md:text-3xl text-xl'>
        All Blog Post</h2>
      ...
      <div className='p-4 flex text-center items-center justify-center gap-8 mb-8'>
        <button onClick={handlePrevPage} disabled={currentPage===1}
          className='bg-[#FFD045] font-medium p-4 rounded-md text-[#1f1073] my-4 hover:scale-105 hover:shadow-lg hover:text-white'>Previous</button>
        <span>Page {currentPage} of {totalPages}</span>
        <button onClick={handleNextPage} disabled={currentPage===totalPages}
          className='bg-[#FFD045] font-medium p-4 rounded-md text-[#1f1073] my-4 hover:scale-105 hover:shadow-lg hover:text-white'>Next</button>
      </div>
